...
import com.spms.parking.dto.response.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleParkingSpaceNotFound(ParkingSpaceNotFoundException ex,
    ...
    public ResponseEntity<ApiError> handleParkingSpaceNotAvailable(ParkingSpaceNotAvailableException ex,
            HttpServletRequest request) {
